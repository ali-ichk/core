...
class InvoiceeGateway extends QueryableGateway implements ScrubbableGateway
{
    ...
    public function selectInvoiceesDetails() {
      ...
      public function selectInvoiceeByAdultID($gibbonPersonID) {
       ...
       public function selectInvoiceeByInvoiceeID($gibbonFinanceInvoiceeID) {
        $data = ['gibbonFinanceInvoiceeID' => $gibbonFinanceInvoiceeID];
        $sql = "SELECT surname, preferredName, gibbonPerson.gibbonPersonID, gibbonFinanceInvoiceeID FROM gibbonFinanceInvoicee JOIN gibbonPerson ON (gibbonFinanceInvoicee.gibbonPersonID=gibbonPerson.gibbonPersonID) WHERE status='Full' AND gibbonFinanceInvoiceeID=:gibbonFinanceInvoiceeID ORDER BY surname, preferredName";
